...
function BASS_StreamGetTags(handle: HSTREAM; tags: DWORD): PChar;
  stdcall; external bassdll;
function BASS_StreamGetFilePosition(handle: HSTREAM; mode: DWORD): DWORD;
  stdcall; external bassdll;

function BASS_RecordGetDeviceDescription(devnum: DWORD): PChar;
  stdcall; external bassdll;
...
function BASS_RecordSetInput(input: integer; setting: DWORD): BOOL;
  stdcall; external bassdll;
